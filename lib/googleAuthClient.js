...
if (!GOOGLE_CLIENT_ID || !GOOGLE_CLIENT_SECRET || !GOOGLE_REDIRECT_URI) {
    logger.error("GoogleAuthClient: CRITICAL ERROR: Google OAuth credentials (GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, GOOGLE_REDIRECT_URI) are not configured for user authentication.");
    throw new Error("Google OAuth configuration incomplete for user authentication.");
}
